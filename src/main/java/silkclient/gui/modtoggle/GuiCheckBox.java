...
public class GuiCheckBox extends GuiButton {
    ...
    private static final Color X_COLOR = Color.WHITE;
...
//            Gui.drawRect(xPosition , yPosition , xPosition + width , yPosition + height, this.checked ? Color.green.getRGB() : Color.red.getRGB());
